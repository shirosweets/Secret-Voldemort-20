...
def return_token_minister():
    player_number_actual_minister= dbf.get_actual_minister(3)
    player_id_actual_minister = dbf.get_player_id_by_player_number(player_number_actual_minister, 3)
    ...
    elif(user_id_actual_minister == 9):
        return logIn.getToken_Iatoy()
    elif(user_id_actual_minister == 10):   
        return logIn.getToken_Joker()

def return_token_NOT_minister():
    player_number_actual_minister= dbf.get_actual_minister(3)
    if player_number_actual_minister == 9:
        player_id_actual_minister = dbf.get_player_id_by_player_number(0, 3)
    elif player_number_actual_minister == 10:
        player_id_actual_minister = dbf.get_player_id_by_player_number(1, 3)
    else:
        player_id_actual_minister = dbf.get_player_id_by_player_number(player_number_actual_minister + 2, 3)
    user_id_actual_minister = dbf.get_user_id_by_player_id(player_id_actual_minister)
...
def return_token_director():
    player_number_actual_director= dbf.get_actual_director(3)
    player_id_actual_director= dbf.get_player_id_by_player_number(player_number_actual_director, 3)
    ...
    if(user_id_actual_director == 1): # Argentina
        ...
        return logIn.getToken_Hugo()
    elif(user_id_actual_director == 9):
        return logIn.getToken_Iatoy()
    elif(user_id_actual_director == 10):   
        return logIn.getToken_Joker()
...
def test_select_director():
    current_game= 3
    minister_number = dbf.get_actual_minister(3)
    director_candidate= candidate_director(minister_number,3)
    response= client.post(
                    "/games/3/select_director/",
                    headers= { 
                        "Authorization": return_token_minister()},
...
def test_vote_candidate_Joker():
    ...
    assert response.status_code == 200
    assert response.json()["voteOut_response"] == " Player Joker has voted"
...
def test_vote_candidate_Iatoy_OK_1():
    token= logIn.getToken_Iatoy()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Joker_OK_1():
    token= logIn.getToken_Joker()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_post_proclamation_1():
    ...
    assert response.json()["board_response"] == " Proclamation card was promulged correctly (ง'-'︠)ง ≧◉ᴥ◉≦"
            ...
            #* CAST SPELL *#
def test_board_game():
    if (dbf.get_last_proclamation(3) == 1):
        if (dbf.get_spell(3) == "Crucio"):
...
def test_vote_candidate_Iatoy_OK_2():
    token= logIn.getToken_Iatoy()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Joker_OK_2():
    token= logIn.getToken_Joker()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Iatoy_OK_3():
    token= logIn.getToken_Iatoy()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Joker_OK_3():
    token= logIn.getToken_Joker()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Iatoy_OK_4():
    token= logIn.getToken_Iatoy()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Joker_OK_4():
    token= logIn.getToken_Joker()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Iatoy_OK_5():
    token= logIn.getToken_Iatoy()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_vote_candidate_Joker_OK_5():
    token= logIn.getToken_Joker()
    response= client.put(
        "/games/3/select_director/vote",
        headers= {
...
def test_board_game_3():
    if (dbf.get_last_proclamation(3) == 1):
        if (dbf.get_spell(3) == "Crucio"):
        ...
        elif (dbf.get_spell(3) == "Avada Kedavra"):
            if (dbf.is_imperius_active(3) == -1):
                minister = dbf.get_actual_minister(3)
            else:
                minister = dbf.is_imperius_active(3)
            ...
            minister_id = dbf.get_player_id_by_player_number(minister, 3)
...
def test_vote_candidate_Argentina_OK_6():
    token= logIn.getToken_Argentina()
    player_number = dbf.get_player_id_from_game(1,3)
...
def test_vote_candidate_Brasil_OK_6():
    token= logIn.getToken_Brasil()
    player_number = dbf.get_player_id_from_game(2,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Carol_OK_6():
    token= logIn.getToken_Carol()
    player_number = dbf.get_player_id_from_game(3,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Dexter_OK_6():
    token= logIn.getToken_Dexter()
    player_number = dbf.get_player_id_from_game(4,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Esteban_quito_OK_6():
    token= logIn.getToken_Esteban_quito()
    player_number = dbf.get_player_id_from_game(5,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_FaMAF_OK_6():
    token= logIn.getToken_FaMAF()
    player_number = dbf.get_player_id_from_game(6,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Ganzua_OK_6():
    token= logIn.getToken_Ganzua()
    player_number = dbf.get_player_id_from_game(7,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Hugo_OK_6():
    token= logIn.getToken_Hugo()
    player_number = dbf.get_player_id_from_game(8,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Iatoy_OK_6():
    token= logIn.getToken_Iatoy()
    player_number = dbf.get_player_id_from_game(9,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
def test_vote_candidate_Joker_OK_6():
    token= logIn.getToken_Joker()
    player_number = dbf.get_player_id_from_game(10,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
            "/games/3/select_director/vote",
            headers= {
...
#?############################# START TURN 8 #############################?#
    ...
    #if((return_fenix_proclamations_game_3() != 5) and (return_death_eater_proclamations_game_3 != 6)):
...
def test_vote_candidate_Iatoy_OK_7():
    token= logIn.getToken_Iatoy()
    player_number = dbf.get_player_id_from_game(9,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
...
def test_vote_candidate_Joker_OK_7():
    token= logIn.getToken_Joker()
    player_number = dbf.get_player_id_from_game(10,3)
    if dbf.is_player_alive(player_number):
        response= client.put(
