...
class Player(db.Entity):
    player_game             = Optional(Game)                               # Depends on Game: one to many relation with Player-Game
    #player_lobby            = Optional(Lobby)                              # Depends on Lobby: one to many relation with Player-Game, is optional because the Lobby is deleted
    #player_user             = Required(User)                               # Depends on User: one to many relation with Player-User [...]
